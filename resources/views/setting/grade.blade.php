            ...
            <div class="row">
                ...
                <div class="col-6 text-right my-3">
                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal"><i
                            class="fa-solid fa-plus px-1"></i>{{ __('Add Grade') }}</button>
                </div>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add grade') }}</h5>
                ...
                {{-- x this is modal for creating grade x --}}
                <div class="col-12">
                            ...
                            @foreach ($grades as $key => $grade)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- this is modal for creating grade --}}
                                        <!-- Modal -->
                                        <div class="modal fade" id="exampleModal{{ $grade->id }}" tabindex="-1"
                                            ...
                                            <form action="{{ route('grade.update', $grade) }}" method="post">
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLongTitle">Add grade
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="description">Description</label>
                                                                        <textarea name="description" id="description{{$grade->id}}">{!! $grade->description !!}</textarea>
                                                                        @error('description')
                                                                            <p class="invalid-feedback" style="font-size: 1rem">
                                                                                {{ $message }}
                                                                            </p>
...
@section('scripts')
    ...
    <script>
        @foreach ($grades as $grade)
            CKEDITOR.replace('description'+{{$grade->id}});
        @endforeach
