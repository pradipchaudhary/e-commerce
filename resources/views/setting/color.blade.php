...
@section('s_child_color', 'block')
@section('setting_color', 'active')
            ...
            <div class="row">
                ...
                <div class="col-6 text-right my-3">
                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal"><i
                            class="fa-solid fa-plus px-1"></i>{{ __('Add color') }}</button>
                </div>
                {{-- this is modal for creating color --}}
                <!-- Modal -->
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add color') }}</h5>
                ...
                {{-- x this is modal for creating color x --}}
                <div class="col-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn-sm btn-primary btn" data-toggle="modal"
                                            data-target="#exampleModal{{ $color->id }}"><i
                                        ...
                                        <div class="modal fade" id="exampleModal{{ $color->id }}" tabindex="-1"
                                            ...
                                            <form action="{{ route('color.update', $color) }}" method="post">
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLongTitle">Add color
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="description">Description</label>
                                                                        <textarea name="description" id="description{{ $color->id }}">{!! $color->description !!}</textarea>
                                                                        @error('description')
                                                                            <p class="invalid-feedback" style="font-size: 1rem">
                                                                                {{ $message }}
                                                                            </p>
...
@section('scripts')
    ...
    <script>
        ...
        @foreach ($colors as $color)
            CKEDITOR.replace('description'+{{$color->id}});
        @endforeach
        $(function() {
            $("#example1").DataTable({
                "responsive": true,
